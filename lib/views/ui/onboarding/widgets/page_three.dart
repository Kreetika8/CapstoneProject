      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset("assets/images/PageThree.png"), // Ensure this asset path is correct
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  ...
                  mainAxisAlignment: MainAxisAlignment.spaceAround, // Center the button
                  children: [
                    CustomOutlineBtn(
                      onTap: () {},
                      text: "Login",
                ...
                ReusableText(text: "Continue as a guest",
                 style: appstyle(16, Color(kLightBlue.value), FontWeight.w400))
              ],
            ),
          ],
        ),
